...
def fetch_paper_titles_and_links(url: str):
    ...
    for tag in paper_tags:
        ...
        href = tag['href']
        link = href if href.startswith("http") else "https://proceedings.mlr.press" + href
...
def icml_crawler():
    ...
    # 전체 최종 저장
    output_path = os.path.join(base_dir, "icml_papers_2024.json")
